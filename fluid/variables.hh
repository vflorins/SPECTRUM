...
struct ConservedVariables
{
   ...
   ConservedStateGasdyn<FLUID_PRIMARY_SPECIE> var_primary;
#elif FLUID_PRIMARY_TYPE == FLUID_MHD
   ConservedStateMHD<FLUID_PRIMARY_SPECIE> var_primary;
#endif

#ifdef PASSIVE_PRIMARY_01
   ConservedStatePassive passive_primary_01;
#endif

#ifdef PASSIVE_PRIMARY_02
   ConservedStatePassive passive_primary_02;
#endif

#if FLUID_SECONDARY_TYPE == FLUID_GASDYN
   ConservedStateGasdyn<FLUID_SECONDARY_SPECIE> var_secondary;
#elif FLUID_SECONDARY_TYPE == FLUID_MHD
   ConservedStateMHD<FLUID_SECONDARY_SPECIE> var_secondary;
#endif

#ifdef PASSIVE_SECONDARY_01
   ConservedStatePassive passive_secondary_01;
#endif

#ifdef PASSIVE_SECONDARY_02
   ConservedStatePassive passive_secondary_02;
#endif

#if FLUID_TERTIARY_TYPE == FLUID_GASDYN
   ConservedStateGasdyn<FLUID_TERTIARY_SPECIE> var_tertiary;
#elif FLUID_TERTIARY_TYPE == FLUID_MHD
   ConservedStateMHD<FLUID_TERTIARY_SPECIE> var_tertiary;
#endif

#ifdef PASSIVE_TERTIARY_01
   ConservedStatePassive passive_tertiary_01;
#endif

#ifdef PASSIVE_TERTIARY_02
   ConservedStatePassive passive_tertiary_02;
#endif

#if FLUID_QUATERNARY_TYPE == FLUID_GASDYN
   ConservedStateGasdyn<FLUID_QUATERNARY_SPECIE> var_quaternary;
#elif FLUID_QUATERNARY_TYPE == FLUID_MHD
   ConservedStateMHD<FLUID_QUATERNARY_SPECIE> var_quaternary;
#endif

#ifdef PASSIVE_QUATERNARY_01
   ConservedStatePassive passive_quaternary_01;
#endif

#ifdef PASSIVE_QUATERNARY_02
   ConservedStatePassive passive_quaternary_02;
#endif

#if TURBULENCE_TYPE == TURB_ZANK6EQ
   ConservedStateZank6eq turbulence;
#endif
