...
if empty_variable_lists:
    ...
    variables = [
        ...
        Variable("FlxDen", "Scalar", "Fluid density flux function", R = 1, S = 1),
        Variable("Prs", "Scalar", "Fluid pressure field", R = 1, S = 1),
        Variable("Enr", "Scalar", "Fluid energy field", R = 1, S = 1),
        Variable("FlxEnr", "Scalar", "Fluid energy flux function", R = 1, S = 0),
        Variable("Vel", "GeoVector", "Fluid velocity field", R = 1, S = 0),
        Variable("Mom", "GeoVector", "Fluid momentum field", R = 1, S = 0),
        Variable("FlxMom", "GeoVector", "Fluid momentum flux function", R = 1, S = 0),
        # MHD variables (extending Fluid variables):
        Variable("Mag", "GeoVector", "Magnetic field", R = 1, S = 0),
        Variable("FlxMag", "GeoVector", "Magnetic field flux function", R = 1, S = 0),
        Variable("Glm", "Scalar", "Lagrange multiplier field of GLM MHD", R = 1, S = 0),
        Variable("FlxGlm", "Scalar", "Lagrange mutlipler flux function of GLM MHD", R = 1, S = 0),
        # Tracer variables:
        Variable("Elc", "GeoVector", "Electric field", R = 1, S = 0),
        Variable("AbsMag", "Scalar", "Magnetic field magnitude", R = 1, S = 0),
        Variable("HatMag", "GeoVector", "Magnetic field direction", R = 1, S = 0),
        Variable("DelVel", "GeoMatrix", "Gradient of velocity field", R = 1, S = 0),
        Variable("DelElc", "GeoMatrix", "Gradient of electric field", R = 1, S = 0),
        Variable("DelMag", "GeoMatrix", "Gradient of magnetic field", R = 1, S = 0),
        Variable("DelAbsMag", "GeoVector", "Gradient of magnetic field magnitude", R = 1, S = 0),
        Variable("DelHatMag", "GeoMatrix", "Gradient of magnetic field direction ", R = 1, S = 0),
        Variable("DerVel", "GeoVector", "Time derivative of velocity field", R = 1, S = 0),
        Variable("DerElc", "GeoVector", "Time derivative of electric field", R = 1, S = 0),
        Variable("DerMag", "GeoVector", "Time derivative of magnetic field", R = 1, S = 0),
        Variable("DerAbsMag", "Scalar", "Time derivative of magnetic field magnitude", R = 1, S = 0),
        Variable("DerHatMag", "GeoVector", "Time derivative of magnetic field direction", R = 1, S = 0),
    ]
    groups = [
        # Fluid groups:
        ...
        VariableGroup("FluxFunctionGASDYN", "FlxDen_t, FlxMom_t, FlxEnr_t", "Variables of the flux function for a gas dynamics model"),
        # MHD groups:
        ...
        VariableGroup("FluxFunctionMHD", "FlxDen_t, FlxMom_t, FlxEnr_t, FlxMag_t", "Variables of the flux function for an MHD model"),
        ...
        VariableGroup("FluxFunctionMHD_GLM", "FlxDen_t, FlxMom_t, FlxEnr_t, FlxMag_t, FlxGlm_t", "Variables of the flux function for an MHD-GLM model"),
    ]
