...
{
   std::string infilename1 = "fields_test_modulation_cartesian_TrajectoryParker_spectrum.dat";
   std::string outfilename = "fields_test_modulation_cartesian_TrajectoryParker_spectrum_pp.dat";
   std::string line;
