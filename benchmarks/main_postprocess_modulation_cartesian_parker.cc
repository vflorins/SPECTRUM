...
{
   std::string infilename1 = "output_data/test_modulation_cartesian_TrajectoryParker_spectrum.dat";
   std::string outfilename = "output_data/test_modulation_cartesian_TrajectoryParker_spectrum_pp.dat";
   std::string line;
