...
// Scattering frequency
   double D0 = Sqr(Particle::LarmorRadius<specie>(momentum, Bmag)) * Particle::CyclotronFrequency<specie>(Particle::Vel<specie>(momentum), Bmag);
   container.Insert(D0);
...
// Spacing between dumps
   double timemark = 0.1 * D0 / Sqr(Particle::Vel<specie>(momentum));
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   if(MPI_Config::is_master) {
      ...
      std::cout << "D0 = " << D0 * Sqr(Particle::unit_length) / Particle::unit_time << std::endl;
      std::cout << "++++++++++++++++++++" << std::endl;
