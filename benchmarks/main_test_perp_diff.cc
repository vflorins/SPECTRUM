...
//----------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   using Fields = Fields<Mag_t, Elc_t, AbsMag_t, HatMag_t, DelMag_t, DelAbsMag_t, DotHatMag_t, DotAbsMag_t>;
   using Trajectory = TrajectoryGuidingDiff<HConfig>;
...
// Scattering frequency
   double D0 = Sqr(LarmorRadius<Config::specie>(momentum, Bmag)) * CyclotronFrequency<Config::specie>(Vel<Config::specie>(momentum), Bmag);
   container.Insert(D0);
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   std::string simulation_files_prefix = "fields_main_test_perp_diff_" + simulation->GetTrajectoryName() + "_";
