...
data_file = "main_test_diff_shock_acc_TrajectoryParkerSource_spectrum_pp.dat"
plot_file = "plot_test_diff_shock_acc_TrajectoryParkerSource_spectrum_pp.png"
...
ax.set_title("DIFFUSIVE SHOCK ACCELERATION", fontsize=32)
ax.loglog(data[:,0], data[:,1], color="black", linestyle='-',
          marker = '', label="theoretical")
