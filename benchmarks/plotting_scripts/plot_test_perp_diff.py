...
data_file = "main_test_perp_diff_TrajectoryGuidingDiff_cumulative_distro2.dat"
plot_file = "plot_test_perp_diff_TrajectoryGuidingDiff_cumulative_distro2.png"
...
with open(r'benchmark_results.txt', 'r') as fp:
   lines = fp.readlines()
   for row in lines:
      word = "PERPENDICULAR DIFFUSION"  # String to search for
      if row.find(word) != -1:
...
ax.set_title("PERPENDICULAR DIFFUSION", fontsize=32)
